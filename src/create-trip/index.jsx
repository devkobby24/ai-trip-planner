...
// import GooglePlacesAutocomplete from "react-google-places-autocomplete"; // Commented out due to quota issue
...
function CreateTrip() {
  const [place, setPlace] = useState(); // Location state
      ...
      <div className="sm:px-10 px-5 mt-10">
        ...
        <div className="mt-20 flex flex-col gap-10">
          <div>
            ...
            {/* GooglePlacesAutocomplete (commented out) */}
            ...
            {SelectBudgetOptions.map((item, index) => (
              <div
                ...
                className={`p-4 border cursor-pointer rounded-lg hover:shadow-lg  flex flex-col items-center md:items-start text-center md:text-left
                    ${
                      formData.budget === item.amountRange &&
        ...
        <div className="mt-10 items-center justify-center flex">
          <Button disabled={loading} onClick={OnGenerateTrip} size="lg">
            {loading ? (
              <l-grid size="35" speed="0.5" color="white"></l-grid>
            ) : (
              "Generate Trip"
            )}
          </Button>
